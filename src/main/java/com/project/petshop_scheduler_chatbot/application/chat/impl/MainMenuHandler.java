...
//     private final RegisterPetHandle registerPetHandle;

//     private final ServicesFormatedList servicesFormatedList;


//     public MainMenuHandler(ScheduleHandler scheduleHandler, RescheduleHandler rescheduleHandler, CancelScheduleHandler cancelScheduleHandler, RegisterPetHandle registerPetHandle, ServicesFormatedList servicesFormatedList) {
//         this.scheduleHandler = scheduleHandler;
//         this.rescheduleHandler = rescheduleHandler;
//         this.cancelScheduleHandler = cancelScheduleHandler;
//         this.registerPetHandle = registerPetHandle;
...
//             return registerPetHandle.handle_STATE_REGISTER_PET_START(conversationSession, messageCommand);
//         }
